...
(Math as any).map = function (n, start, stop, start2, stop2) {
...
export default function ASCIIText({
  ...
  return (
    <div ref={containerRef} className="ascii-text-container relative h-full w-full">
      <style>{`
        ...
        .ascii-text-container pre {
          ...
          left: 0;
          top: 0;
          background-image: radial-gradient(circle, #67e8f9 0%, #c084fc 50%, #f472b6 100%);
