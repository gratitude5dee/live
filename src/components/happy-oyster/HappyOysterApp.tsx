...
// authoritative snapshot to one AppView (lib/happy-oyster/view.ts) and the two
// regions switch what they show off it, so the page always mirrors the
...
import { LiveClientProvider } from "./ho-client";
