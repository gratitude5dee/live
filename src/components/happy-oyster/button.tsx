...
// HappyOyster's own button (ported from happy-oyster/components/ui/button.tsx).
// Kept inside the happy-oyster folder so the project's shadcn
// src/components/ui/button.tsx stays untouched.
