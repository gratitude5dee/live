...
// Shown when REACTOR_API_KEY is missing on the server.
// Pure markup, no hooks — the TanStack Start port of happy-oyster's
// server-rendered setup landing.
          ...
          <ol className="mt-5 space-y-4 text-sm text-zinc-300">
            ...
            <li className="flex gap-3">
              ...
              <div className="min-w-0 flex-1">
                <p>
                  ...
                  project root (or your host&apos;s environment settings when
                  deployed):
                </p>
            ...
            <li className="flex gap-3">
              ...
              <span>
                ...
                <code className="text-zinc-200">npm run dev</code>) so the new
